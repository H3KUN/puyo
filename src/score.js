class Score{
    static initialize(){
        ...
        for(let i = 0;i < 10;i++){
            ...
            if(fontWidth === 0)fontWidth = fontImage.width / fontImage.height * Config.fontHeight;
    ...
    static showScore(){
        ...
        while(scoreElement.firstChild)scoreElement.removeChild(scoreElement.firstChild);
